  ...
  propertyGetData(params){
    ...
    //this is for multiple image
      response.res.forEach((multiImage)=>{
          ...
          multiImage.propertyShowImage.forEach((insideData)=>{
            ...
            this.multiImageData.push('https://nameless-bayou-49909.herokuapp.com/' + insideData)
          })
       })
    ...
    //this is for multiple image 
      ...
      response.res.forEach((data)=>{
        ...
        this.imgData.push('https://nameless-bayou-49909.herokuapp.com/' + data.propertyimage)
